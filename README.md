 ...
 * Feature 1 – Allow users to get to know the latest offers with a call to action at the beginning of the homepage.

 * Feature 2 – Allow users to discover the benefits of buying the product by viewing a list of short and concise messagess as they scroll the homepage. Animated icons have been incorporated to give a better visual element to the project. 

 * Feature 3 – Reassure the user that he is welcome. A dedicated section in the homepage displays that the product is inclusive, no need for previous experience to be able to benefit from.

 * Feature 4 – Show the users the main strenght of the product: flexibility. DY classes can be practiced remotely to fit the lifestile of anyone. A call to action will direct users to the dedicated page.
 ...
 * Feature 1 – Improving the visual layout of the timetable when viewed on large screens, as well as implement pop up pages when clicking on the class names to get a brief description.
...
* Balsamiq Desktop -> [Visit Site]( https://balsamiq.com/wireframes/desktop/)
    * Balsamiq was used to create the wireframes for my project.
